...
class AuthRepositoryImpl extends AuthRepository{
  ...
  // @override
  // Future<Either<Result<UserEntity>, ApiError>> login(Map<String, dynamic> data) async {
  ...
  //             } else {
  //               return Right(ApiError(message: "Login Request failed"));
  //             }
  //
  //           },
  //           (error)
  ...
  @override
  Future<Either<Result<UserEntity>, ApiError>> verify(Map<String, dynamic> data) async {
    ...
    return res.fold(
            (success)
        {
          if(success.isSuccess){
            ...
            return Right(ApiError(message: "Signup Request failed"));
          }
