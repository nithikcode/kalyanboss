...
class AuthUseCases {
  ...
  AuthUseCases({required this.loginUseCase,required  this.verifyUseCase, required this.signUpUseCase, required this.sendOtpUseCase, required this.fetchProfileUseCase});
}