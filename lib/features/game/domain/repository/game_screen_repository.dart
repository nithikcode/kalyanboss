...
abstract class GameScreenRepository {
  ...
  Future<Either<Result<BetResponseEntity>, ApiError>> betHistory(Map<String, dynamic> data,);
  Future<Either<Result<TransactionEntity>, ApiError>> transactionHistory(Map<String, dynamic> data,);
